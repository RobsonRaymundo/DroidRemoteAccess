 ...
 */
public class CreateFileMensageActivity extends BaseDemoActivity {



    private static final String TAG = "CreateFileMensageActivity";
            ...
            new Thread() {
                ...
                public void run() {
                    ...
                    try {
                        ...
                        try {
                            String msg = getIntent().getStringExtra(Constantes.CHAMADAPORCOMANDOTEXTO);
                            writer.write(msg);
                            writer.close();
                        } catch (IOException e) {
